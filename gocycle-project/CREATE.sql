...
create table Store(
                      ...
                      manager int unique not null references Client (id) ,
                      address varchar(100) not null,
...
insert into Client (name, address , email , phone, CC, nationality, atrdisc) values ('alice', 'chelas', 'alice@hotmail.com', '123456789', '234253255','Portuguese' ,'C');
insert into Client (name, address , email , phone, CC, nationality, atrdisc) values ('bob', 'sintra', 'bob@hotmail.com', '987654321', '983329805', 'Chinese', 'C');
insert into Client (name, address , email , phone, CC, nationality, atrdisc) values ('desmond', 'porto', 'desmond@hotmail.com', '3270523750', '252379032', 'English', 'G');
insert into Client (name, address , email , phone, CC, nationality, atrdisc) values ('richard', 'olivais', 'richard@hotmail.com', '358253523', '235235235', 'Portuguese', 'C');
...
insert into electric_bike values (2, 500, 33);
insert into electric_bike values (4, 450, 30);
